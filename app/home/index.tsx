...
const MODULOS: { titulo: string; descricao: string; rota: string }[] = [
  ...
  { titulo: "Ordens de Serviço", descricao: "Abrir e acompanhar ordens", rota: "/ordem-de-servico" },
      ...
      <View style={styles.cabecalho}>
        <View>
          ...
          <Text style={styles.subtitulo}>
            {user?.role === "technician" ? "Perfil: técnico" : user?.role === "client" ? "Perfil: cliente" : ""}
          </Text>
        </View>
        <Pressable
          onPress={() => {
...
const styles = StyleSheet.create({
  cabecalho: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", marginBottom: spacing.lg },
